...
function bbs_global_enqueues() {
	...
	/* Added by Ravi */
	wp_enqueue_style( 'jsgridcss', get_stylesheet_directory_uri() . '/RMM/jsgrid/jsgrid.css' , CHILD_THEME_VERSION );
	wp_enqueue_style( 'jsgrid-theme', get_stylesheet_directory_uri() . '/RMM/jsgrid/jsgrid-theme.min.css' , CHILD_THEME_VERSION );
	wp_enqueue_style( 'jquery-ui', get_stylesheet_directory_uri() . '/RMM/style/jquery-ui.css');
	wp_enqueue_style( 'jquery-ui-timepicker', get_stylesheet_directory_uri() . '/RMM/style/jquery-ui-timepicker-addon.css');	
	
	wp_enqueue_script('jquery-ui', get_stylesheet_directory_uri().'/RMM/js/jquery-ui.js', array('jquery'), CHILD_THEME_VERSION);
	wp_enqueue_script('jquery-ui-timepicker', get_stylesheet_directory_uri().'/RMM/js/jquery-ui-timepicker-addon.js', array('jquery'), CHILD_THEME_VERSION);
	wp_enqueue_script( 'jsgrid', get_stylesheet_directory_uri(). '/RMM/jsgrid/jsgrid.js', CHILD_THEME_VERSION);
	/* Added by Ravi */
}
