...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        noDataRowClass: "jsgrid1-nodata-row",

        heading: true,
        headerRowRenderer: null,
        headerRowClass: "jsgrid1-header-row",
        headerCellClass: "jsgrid1-header-cell",

        filtering: false,
        filterRowRenderer: null,
        filterRowClass: "jsgrid1-filter-row",

        inserting: false,
        insertRowRenderer: null,
        insertRowClass: "jsgrid1-insert-row",

        editing: false,
        editRowRenderer: null,
        editRowClass: "jsgrid1-edit-row",

        confirmDeleting: true,
        deleteConfirm: "Are you sure?",

        selecting: true,
        selectedRowClass: "jsgrid1-selected-row",
        oddRowClass: "jsgrid1-row",
        evenRowClass: "jsgrid1-alt-row",
        cellClass: "jsgrid1-cell",

        sorting: false,
        sortableClass: "jsgrid1-header-sortable",
        sortAscClass: "jsgrid1-header-sort jsgrid1-header-sort-asc",
        sortDescClass: "jsgrid1-header-sort jsgrid1-header-sort-desc",
        ...
        pagerContainerClass: "jsgrid1-pager-container",
        pagerClass: "jsgrid1-pager",
        pagerNavButtonClass: "jsgrid1-pager-nav-button",
        pagerNavButtonInactiveClass: "jsgrid1-pager-nav-inactive-button",
        pageClass: "jsgrid1-pager-page",
        currentPageClass: "jsgrid1-pager-current-page",
        ...
        invalidClass: "jsgrid1-invalid",

        containerClass: "jsgrid",
        tableClass: "jsgrid1-table",
        gridHeaderClass: "jsgrid1-grid1-header",
        gridBodyClass: "jsgrid1-grid1-body",
        ...
        _createHeader: function() {
            ...
            var $header = this._header = $("<div>").addClass(this.gridHeaderClass)
                .addClass(this._scrollBarWidth() ? "jsgrid1-header-scrollbar" : "")
                .append($headerGrid);
        ...
        _prepareCell: function(cell, field, cssprop, cellClass) {
            return $(cell).css("width", field.width)
                ...
                .addClass(field.align ? ("jsgrid1-align-" + field.align) : "");
        },
...
(function(jsGrid, $, undefined) {
    ...
    LoadIndicator.prototype = {
        ...
        zIndex: 1000,
        shaderClass: "jsgrid1-load-shader",
        loadPanelClass: "jsgrid1-load-panel",
...
(function(jsGrid, $, undefined) {
    ...
    function HyperlinkField(config) { //CheckboxField
        Field.call(this, config);
    }

    HyperlinkField.prototype = new Field({//CheckboxField

        itemTemplate: function(value) {
            return this._createHyperlink().prop({
                href: value,
                text: value
            });
        },
        ...
        insertTemplate: function() {
            ...
            return this.insertControl = this._createHyperlink();
        },
       ...
       /* editTemplate: function(value) {
            ...
            var $result = this.editControl = this._createHyperlink();
        ...
        insertValue: function() { //CheckboxField
             return this.insertControl.val();
        },
        ...
        _createHyperlink: function() {  //CheckboxField
            return $("<a>").attr("target", "_blank");
        }
    });

    jsGrid.fields.checkbox = jsGrid.HyperlinkField = HyperlinkField; //CheckboxField
...
(function(jsGrid, $, undefined) {
    ...
    ControlField.prototype = new Field({
        ...
        buttonClass: "jsgrid1-button",
        modeButtonClass: "jsgrid1-mode-button",

        modeOnButtonClass: "jsgrid1-mode-on-button",
        searchModeButtonClass: "jsgrid1-search-mode-button",
        insertModeButtonClass: "jsgrid1-insert-mode-button",
        editButtonClass: "jsgrid1-edit-button",
        deleteButtonClass: "jsgrid1-delete-button",
        searchButtonClass: "jsgrid1-search-button",
        clearFilterButtonClass: "jsgrid1-clear-filter-button",
        insertButtonClass: "jsgrid1-insert-button",
        updateButtonClass: "jsgrid1-update-button",
        cancelEditButtonClass: "jsgrid1-cancel-edit-button",
